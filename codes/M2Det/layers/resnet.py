...
__all__ = ['ResNet', 'self_resnet', 'resnet18', 'resnet34', 'resnet50', 'resnet101',
           'resnet152']
...
def self_resnet(pretrained=False, **kwargs):
...
def resnet18(pretrained=False, **kwargs):
    ...
    if pretrained:
        #state_dict = model_zoo.load_url(model_urls['resnet101'], map_location=lambda storage, loc: storage.cuda())
...
def resnet152(pretrained=False, **kwargs):
    ...
    if pretrained:
        state_dict = model_zoo.load_url(model_urls['resnet152'], map_location=lambda storage, loc: storage.cuda())
        model.load_state_dict(state_dict)
    return model
